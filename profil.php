                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" name="nama" placeholder="Nama" class="form-control bg-light border-1 small" value="<?= $row['nama'] ?>" required>
                                        <label for="" class="col-form-label">Username</label>
                                        <input type="text" name="username" placeholder="Username" class="form-control bg-light border-1 small" value="<?= $row['username'] ?>" required>
                                        <label for="" class="col-form-label">Password</label>
                                        <input type="text" name="password" placeholder="Password" class="form-control bg-light border-1 small" value="<?= $row['password'] ?>" required>
                                        <label for="" class="col-form-label">Level</label>
                                        <input type="text" name="password" placeholder="" class="form-control bg-light border-1 small" value="<?= $row['level'] ?>" disabled>
                                        <p class="text-danger mt-2">Note * Setelah mengedit data Anda akan otomatis keluar dan harus login lagi</p>
                                    </div>
                                        <input type="submit" class="btn btn-facebook btn-block mt-3" name="edit" value="Edit Profil User" onclick="return confirm('Yakin edit profil user?')">
                                        </form>
                                    <?php } ?>
                                </div>
                            </div>
