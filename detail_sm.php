                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <p class=" h6 m-0 font-weight-bold text-primary">Detail Surat Masuk</p>
                                </div>
                                <div class="card-body">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <input type="text" name="nosm" placeholder="" class="form-control bg-light border-1 small" readonly value="<?= $t['no_suratmasuk'] ?>">
                                            ...
                                            <input type="text" name="asal" placeholder="" class="form-control bg-light border-1 small" readonly value="<?= $t['asal_surat'] ?>">
                                            ...
                                            <textarea name="keterangan" placeholder="" id="" cols="10" rows="5" class="form-control bg-light border-1 small" readonly><?= $t['ket_suratmasuk'] ?></textarea>                                         
                                            </div>

                                            <div class="col-md-6">
                                            <label for="" class="col-form-label">Kode Klasifikasi Surat</label>
                                            <input type="text" name="asal" placeholder="" class="form-control bg-light border-1 small" required value="<?= $t['kode_klasifikasi'] ?>">
                                            ...
                                            <input type="date" name="tglsm" class="form-control bg-light border-1 small" readonly value="<?= $t['tgl_diterima'] ?>">
                                            ...
                                            <label for="" class="col-form-label">File Surat : Klik File untuk melihat full gambar</label><br>
                                                                <?php
                                                                    if($t['file_suratmasuk']=='TIDAK ADA FILE'){
                                                                        ...
                                                                        ?>
                                                                        <a href="fsm.php?id=<?= $t['id_suratmasuk'] ?>" ><img src='file/suratmasuk/<?=$t['file_suratmasuk']?>' alt='<?=$t['file_suratmasuk']  ?>' width='30%'></a><br>
                                                                        <?php
                                                                    }
                                                                ?>
                                            </div>
